...
```{r}
# # adjusted color in response to reviewer comments
# f3a2 <- f3b +
#   theme(legend.position = "none",
#         axis.title.x = element_blank(), 
#         axis.text.x = element_blank()) + 
#   scale_color_brewer(type = "qual", palette = "Accent", direction = 1,
#                      labels = c('Host traits only', 'Stages only'))
# 
# f3b2 <- f3a + 
#   theme(legend.position = c(0.9, 0.175),
...
#                      labels = c('Host traits only', 'Stages only'))
# 
# f3 <- cowplot::plot_grid(f3a2, f3b2, f3c2, f3d2, align="hv", ncol = 1, labels = c('(a)', '(b)', '(c)', '(d)'))
# 
# ggsave(f3, filename = "../../figs/fig4_imp_rev.svg",
#        width = 8, height =  3.5*4)
```
