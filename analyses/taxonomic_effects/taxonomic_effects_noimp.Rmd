...
fig_e1 <- plot_grid(fbm3, 
                    ...
                    align = "hv",
                    nrow = 1)
ggsave(fig_e1, filename = "../../figs/fig_e1_noimp.png", width = 9, height = 3)
ggsave(fig_e1, filename = "../../figs/fig_e1_noimp.svg", width = 9, height = 3) # move closer together
```
...
make_tax_var_plot <- function(m){
  ...
  # calculate fixed effects var
  p_all <- as.matrix(X) %*% t(sol[,1:num_fe]) # predicteds for every post sample
  p1 <- p_all[1:l,] # preds for initial size
  p2 <- p_all[(l+1):(l*2),] # preds for final size
...
make_tax_var_plot <- function(m){
  ...
  # calculate fixed effects var
  p_all <- as.matrix(X) %*% t(sol[,1:num_fe]) # predicteds for every post sample
  p1 <- p_all[1:l,] # preds for prop size
  p2 <- p_all[(l+1):(l*2),] # preds for final size
  p3 <- p_all[(l*2 + 1):(l*3),] # preds for dt
...
fig_e2 <- plot_grid(fis3, 
                    ...
                    align = "hv",
                    nrow = 2)
ggsave(fig_e2, filename = "../../figs/fig_e2_noimp.png", width = 9, height = 6)
ggsave(fig_e2, filename = "../../figs/fig_e2_noimp.svg", width = 9, height = 6) # move closer together
```
...
```
```{r}
ggsave(fe1_gif, filename = "../../figs/gif_imp_vs_noimp/fige1_noimp.png", width = 9, height = 3)
ggsave(fe2_gif, filename = "../../figs/gif_imp_vs_noimp/fige2_noimp.png", width = 9, height = 6)
```
